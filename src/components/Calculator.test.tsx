import { replaceEndDigits } from "./Calculator";
import { reducer, State, initialState } from "../reducers/calculatorReducer";
import { Types } from "../reducers/calculatorReducer";

describe("replaceEndDigits", () => {
  it("should clear any remaining numerical chars from the end of a string", () => {
    expect(replaceEndDigits("")).toBe("");
    expect(replaceEndDigits("2+.1")).toBe("2+");
    expect(replaceEndDigits("2+23+123+31.1")).toBe("2+23+123+");
  });
});
